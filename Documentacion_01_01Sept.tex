...
\subsection{OpenNi}
Es un framework \glossary{name={Framework}, description={Un Framework es un conjunto de clases que sirven para resolver una necesidad específica y comunmente está orientado a objetos además de ser extensible.}} multi-language, cross-platform \glossary{name={Cross-Platform}, description={Multi-Plataforma. Todo software o dispositivo capaz de poder utilizarse en diferentes plataformas, como ser, diversos sistemas  operativos.}}que define un API para desarrollo de aplicaciones, está compuesta por un grupo de interfaces que permiten el acceso a los sensores de audio y visión, OpenNi es un software Open Source desarrollado por PrimeSense, empresa israelí que desarrolló la tecnología del Kinect.

\subsubsection{NITE.}
NITE es un middleware \glossary{name={Middleware}, description={Software de computadora  que conecta componentes de software o aplicaciones para que puedan intercambiar datos entre estas}} para el procesamiento de los datos de Kinect que provee las siguientes características:
\begin{itemize}
...
%DEFINICIÓN DE LA GRAMATICA QUE MANEJA (no recuerdo bien que era de ese punto)
\begin{itemize}
...
\bibitem{Play.com} Play Website by Rakuten \url{http://www.play.com/Games/Xbox360/4-/10296372/Kinect/Product.html}
\bibitem{Alegsa API} Alegsa, Diccionario de informática, API, \url{http://www.alegsa.com.ar/Dic/api.php}
\bibitem{Open Kinect} Open Kinect Org, \url{http://www.openkinect.org}
\bibitem{W3 EMMA} W3 EMMA, Extensible Multimodal Annotation Markup Language \url{http://www.w3.org/TR/2004/WD-emma-20041214/}
\bibitem{Microsoft Speech Platform Runtime} MSDN,Microsoft Speech Platform Runtime \url{http://msdn.microsoft.com/en-us/library/hh362855}
\end{thebibliography}
